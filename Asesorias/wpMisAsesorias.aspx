<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/mpPrincipal.Master" AutoEventWireup="true" CodeBehind="wpMisAsesorias.aspx.cs" Inherits="Asesorias.wpMisAsesorias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    AutoGenerateColumns="False" AllowPaging="True" PageSize="10" OnPageIndexChanging="gvAsesorias_PageIndexChanging"
    EmptyDataText="No tienes asesorías registradas">
    <Columns>
        <asp:BoundField DataField="id" HeaderText="ID" />
        <asp:BoundField DataField="docente_nombre" HeaderText="Docente" />
        <asp:BoundField DataField="materia_nombre" HeaderText="Materia" />
        <asp:BoundField DataField="fecha_formateada" HeaderText="Fecha" />
